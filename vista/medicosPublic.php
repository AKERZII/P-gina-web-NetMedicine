        ...
        <?php else: ?>
            <?php foreach ($medicos as $medico): ?>
                <div class="col-md-4 col-lg-3 medico-card" 
                     ...
                     data-nombre="<?php echo htmlspecialchars(strtolower($medico['nombre'])); ?>">
                    <div class="card">
                        <!-- Imagen del médico -->
                        <?php if (!empty($medico['foto'])): ?>
                            <img src="<?php echo htmlspecialchars($medico['foto']); ?>" 
                                 class="card-img-top" 
                                 alt="<?php echo htmlspecialchars($medico['nombre']); ?>"
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($medico['nombre']); ?></h5>
